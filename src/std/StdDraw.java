package std; /******************************************************************************
 *  Compilation:  javac std.StdDraw.java
 *  Execution:    java std.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code std.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use standard drawing, you must have {@code std.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">std.StdDraw.java</a>
 ...
 *           std.StdDraw.setPenRadius(0.05);
 *           std.StdDraw.setPenColor(std.StdDraw.BLUE);
 *           std.StdDraw.point(0.5, 0.5);
 *           std.StdDraw.setPenColor(std.StdDraw.MAGENTA);
 *           std.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code std.StdDraw.line()} and {@code std.StdDraw.point()}
 *  draw lines and points; the methods {@code std.StdDraw.setPenRadius()}
 *  and {@code std.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code std.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *  </ul>
 *  <p>
 *  For example, {@code std.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code std.StdDraw.setPenColor(std.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code std.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code std.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   std.StdDraw.setFont(font);
 *   std.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code std.StdDraw.clear(std.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   std.StdDraw.setScale(-2, +2);
 *   std.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       std.StdDraw.clear();
 *       std.StdDraw.filledCircle(x, y, 0.05);
 *       std.StdDraw.filledCircle(-x, -y, 0.05);
 *       std.StdDraw.show();
 *       std.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * {@code std.StdDraw.BLACK}, {@code std.StdDraw.BLUE}, {@code std.StdDraw.CYAN},
     * {@code std.StdDraw.DARK_GRAY}, {@code std.StdDraw.GRAY}, {@code std.StdDraw.GREEN},
     * {@code std.StdDraw.LIGHT_GRAY}, {@code std.StdDraw.MAGENTA}, {@code std.StdDraw.ORANGE},
     * {@code std.StdDraw.PINK}, {@code std.StdDraw.RED}, {@code std.StdDraw.WHITE}, and
     * {@code std.StdDraw.YELLOW}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to std.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to std.StdDraw)
        try {
            URL url = std.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
