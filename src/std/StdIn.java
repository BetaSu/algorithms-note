package std; /******************************************************************************
 *  Compilation:  javac std.StdIn.java
 *  Execution:    java std.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code std.StdIn} class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!std.StdIn.isEmpty()) {
 *      double value = std.StdIn.readDouble();
 *      std.StdOut.println(value);
 *  }
 *  std.StdOut.println(sum);
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (std.StdIn.hasNextChar()) {
 *      char c = std.StdIn.readChar();
 *      std.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (std.StdIn.hasNextLine()) {
 *      String line = std.StdIn.readLine();
 *      std.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = std.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code std.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code std.StdIn} is a set of static methods and reads
 ...
 *  Windows, and Linux.
 *  The methods in {@code std.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code std.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to std.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to std.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to std.StdIn,
    ...
    //// end: section (2 of 2) of code duplicated from In to std.StdIn


    // do this once when std.StdIn is initialized
    static {
        resync();
    }

    /**
     * If std.StdIn changes, use this to reinitialize the scanner.
     */
